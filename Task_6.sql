-- SQL Practice
-- Q6:Display all employees whose Department is Robotics AND Salary is greater than 30000.
...
SELECT Name,Department,Salary from Employee where Department = "Robotics" and Salary>30000 ;